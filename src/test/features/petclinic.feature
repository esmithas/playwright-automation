...
Feature: Gestión de Dueños y Mascotas en Petclinic
    ...
    Scenario: Ingresar un Nuevo Owner
        ...
        And registro el owner en el formulario con los datos
            ...
            | Anti      | Guerrero W. | Av. Buenos Aires | Piura | 9331569950 |
        And que me dirigo al menú de find owners
        And accedo a la lista de owners
        Then el nuevo owner "Anti Guerrero W." debe aparecer correctamente en la lista de owners

    @EditOwner
    Scenario: Buscar y Editar un Owner
        Given que me dirigo al menú de find owners
        When filtro al owner por su apellido "Guerrero W."
        And valido que se muestra el owner a editar "Anti Guerrero W."
        ...
        And que me dirigo al menú de find owners
        And filtro al owner por su apellido "Guerrero W."
        And busco al owner "Anti Guerrero W." y valido que se actualizo el correo "Address update v3"
    ...
    Scenario: Agregar 2 Pets a un Owner y Validar que Aparezcan en la Lista de Pets
        ...
        And que me dirigo al menú de find owners
        And accedo a la lista de owners
        Then busco al owner "Guerrero W." y valido que se encuentran las mascotas
            | namePet |
            | Chrono  |
            | Garras  |
